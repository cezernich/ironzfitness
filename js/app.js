...
/* =====================================================================
   ...
   Note: the old settings-page zone editor (saveTrainingZonesSettings /
   loadZonesIntoForm) was removed — it targeted DOM ids (zone-run-easy,
   zone-ftp, zone-hr-max, …) that no longer exist in index.html and was
   never called. Zones are now managed through onboarding / training-zones.js.
   ===================================================================== */
